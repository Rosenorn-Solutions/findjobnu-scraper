...
CREATE TABLE categories (
    ...
    listing_url NVARCHAR(900) NOT NULL,
...
CREATE TABLE jobs (
    ...
    canonical_job_url NVARCHAR(900) NOT NULL UNIQUE,
...
CREATE TABLE job_observations (
    ...
    listing_page_url NVARCHAR(900) NOT NULL,
    listing_position INT NOT NULL,
    job_url_raw NVARCHAR(900) NOT NULL,
    job_title_raw NVARCHAR(MAX) NULL,
    company_name_raw NVARCHAR(255) NULL,
    company_url_raw NVARCHAR(900) NULL,
    location_raw NVARCHAR(255) NULL,
    published_raw NVARCHAR(255) NULL,
    banner_image_url_raw NVARCHAR(900) NULL,
    footer_image_url_raw NVARCHAR(900) NULL,
...
CREATE TABLE job_images (
    ...
    source_url NVARCHAR(900) NOT NULL,
...
CREATE TABLE job_snapshots (
    ...
    company_url_raw NVARCHAR(900) NULL,
    company_url_normalized NVARCHAR(900) NULL,
    location_raw NVARCHAR(255) NULL,
...
CREATE TABLE scrape_events (
    ...
    canonical_job_url NVARCHAR(900) NULL,
